...
/**
 * Strings for component 'mnet', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   mnet
...
$string['addnewhost'] = 'Afig un nou servidor';
...
$string['expired'] = 'Esta clau ha expirat';
$string['expireyourkey'] = 'Suprimeix esta clau';
$string['expireyourkeyexplain'] = 'Moodle fa rotar automàticament les claus cada 28 dies (per defecte), però teniu l\'opció de fer caducar <em>manualment</em> esta clau en qualsevol moment. Això només serà útil si creeu que esta clau ha estat compromesa. Es generarà automàticament un reemplaçament de manera immediata. <br /> Suprimir esta clau farà que siga impossible per a altres aplicacions comunicar-se amb vós, fins que contacteu manualment amb cada administrador per donar-los la nova clau.';
...
$string['hostexists'] = 'Un registre existeix per al servidor amb este nom ( pot ser suprimit). <a href="{$a}">Premeu ací</a> per editar este registre.';
$string['idhelp'] = 'Este valor s\'assigna de forma automàtica i no es pot canviar';
$string['installnosuchfunction'] = 'Error de codificació! Algú està intentant instal·lar una funció xmlrpc  mnet ({$a->method}) des d\'el fitxer ({$a->file}) i no es pot trobar!';
...
$string['loginlinkmnetuser'] = '<br/>Si sou un usuari remot de Moodle en Xarxa i podeu <a href="{$a}">confirmar la vostra adreça de correu ací</a>, vos podem redirigir a la vostra pàgina d\'entrada.<br />';
$string['mnetidproviderdesc'] = 'Podeu utilitzar esta funció per obtindre un enllaç que permeta connectar-vos, si podeu proporcionar l\'adreça de correu electrònic correcta perquè coincidisca amb el nom d\'usuari que ja ha intentat iniciar la sessió.';
$string['noaddressforhost'] = 'Perdoneu, però no s\'ha pogut connectar amb este servidor ({$a})!';
...
$string['notmoodleapplication'] = 'ADVERTIMENT: Esta no es una aplicació de Moodle, de manera que alguns dels mètodes d\'inspecció no funcionen correctament.';
...
$string['peerprofilefielddesc'] = 'Ací es pot reemplaçar la configuració global per cada camp del perfil per enviar o importar quan es crei un nou usuari.';
...
$string['ssoaclneeds'] = 'Per tal que esta funcionalitat estiga habilitada, vos cal activar el treball en xarxa, i el connector d\'autenticació per Moodle en xarxa.';
$string['theypublish'] = 'Facen pública';
$string['transport_help'] = 'Estes opcions són reciproques, de forma que sols podeu forçar un servidor remot a utilitzar SSL certificat si el vostre servidor  és un servidor SSL certificat.';
...
$string['xmlrpc-missing'] = 'Vos cal instal·lar XML-RPC al vostre PHP per habilitar l\'ús d\'esta característica.';
