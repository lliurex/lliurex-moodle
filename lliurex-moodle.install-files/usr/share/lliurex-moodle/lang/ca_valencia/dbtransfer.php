...
/**
 * Strings for component 'dbtransfer', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   dbtransfer
...
$string['done'] = 'Fet';
$string['exportschemaexception'] = 'L\'estructura d\'esta base de dades no concorda amb tots els fitxers install.xml. <br /> {$a}';
$string['importschemaexception'] = 'L\'estructura d\'esta base de dades no concorda amb tots els fitxers install.xml. <br /> {$a}';
$string['importversionmismatchexception'] = 'Esta versió
{$a->currentver}
no concorda amb la versió exportada
{$a->schemaver}.';
$string['malformedxmlexception'] = 'S\'ha trobat un XML malmés, no es pot continuar.';
