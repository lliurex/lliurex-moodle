...
/**
 * Strings for component 'cohort', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   cohort
...
$string['addcohort'] = 'Afig una cohort nova';
$string['backtocohorts'] = 'Torneu a les cohorts';
