...
/**
 * Strings for component 'role', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   role
...
$string['addrole'] = 'Afig un nou rol';
...
$string['assignroles_help'] = 'Quan assigneu un rol a un usuari en un context, li esteu atorgant els permisos que conté este rol, en este context i en tots els contextos "inferiors". Per exemple, si atorgueu el rol d\'estudiant a un usuari en un curs, esta persona tindrà este rol en este curs i en tots els blocs i activitats dins del curs.';
...
$string['checkuserspermissionshere'] = 'Comprovar els permisos que {$a->fullname} té en este {$a->contextlevel}';
$string['chooseroletoassign'] = 'Per favor, escolliu un rol per assignar';
$string['community:add'] = 'Usar el bloc de comunitat per buscar hubs i trobar cursos';
$string['confirmunassign'] = 'Esteu segur que voleu eliminar este rol d\'este usuari?';
$string['createthisrole'] = 'Crear este rol';
$string['deleterolesure'] = '<p>Esteu segur que voleu suprimir el rol «{$a->name} ({$a->shortname})»?</p><p>Actualment este rol està assignat a {$a->count} usuaris.</p>';
...
* No establit
* Permés - S\'atorga el permís per a esta capacitat
* Denegat - Se suprimeix el permís per a esta capacitat, fins i tot en cas que s\'haja atorgat el permís en un context superior.
* Prohibit - Es denega completament el permís i no es poden definir excepcions en un context inferior (més específic).';
$string['resetrolesurenolegacy'] = 'Segur que voleu netejar tots els permisos definits en este rol "{$a->name} ({$a->shortname})"?';
