...
/**
 * Strings for component 'enrol_flatfile', language 'ca_valencia', version '3.9'.
 *
...
* operació, rol, ID(usuari), ID(curs) [, data d\'inici , data caducitat]
 on:
* operació = add | del (afig | suprimeix)
