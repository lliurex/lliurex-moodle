...
/**
 * Strings for component 'auth_shibboleth', language 'ca_valencia', version '3.9'.
 *
...
$string['auth_shib_contact_administrator'] = 'En cas que no estigueu associat amb les organitzacions donades i vos calga accés al curs en aquest servidor, contacteu amb l\'<a href="mailto:{$a}">Administrador de Moodle</a>.';
...
$string['auth_shib_integrated_wayf_description'] = 'Si ho habiliteu, Moodle utilitzarà el seu propi servei WAYF en lloc del que proporciona Shibboleth. Moodle mostrarà una llista desplegable en esta pàgina alternativa d\'inici de sessió on l\'usuari haurà de seleccionar el seu proveïdor d\'identitats.';
...
$string['auth_shib_logout_url_description'] = 'Proporciona l\'URL per al gestor de desconnexió del proveïdor de servei Shibboleth. Este és normalment <tt>/Shibboleth.sso/Logout</tt>';
...
$string['shib_invalid_account_error'] = 'Sembla que esteu autenticat amb Shibboleth, però Moodle no vos té registrat amb aquest nom d\'usuari. Potser el vostre compte no existeix o ha estat suspès.';
