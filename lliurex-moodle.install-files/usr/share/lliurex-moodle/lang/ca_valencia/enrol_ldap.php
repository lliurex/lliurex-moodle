...
/**
 * Strings for component 'enrol_ldap', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_ldap
...
$string['memberattribute_isdn'] = 'Si el membre del grup conté noms distingits cal que ho especifiqueu ací. Si això és així, vos caldrà configurar els paràmetres que queden en esta secció.';
...
$string['phpldap_noextension'] = '<em>El modul LDAP de PHP pareix que no estiga instal·lat. Per favor comproveu que és instal·lat si voleu utilitzar el connector d\'inscripció.</em>';
...
<p>Per a utilitzar inscripció per LDAP, <strong>cal</strong> que els vostres usuaris tinguen un camp idnumber vàlid. Els grups LDAP han de tindre este idnumber en els camps de membre perquè un usuari siga inscrit en el curs. Si ja esteu utilitzant autenticació per LDAP, generalment això vos funcionarà.</p>
...
<p>Este connector també es pot configurar per crear automàticament nous cursos quan apareixen nous grups en el LDAP.</p>';
$string['user_attribute'] = 'Si el membre del grup conté noms distingits, especifiqueu l\'atribut utilitzat en nom/cerca d\'usuaris. Si esteu utilitzant autenticació LDAP, este valor sol trobar l\'atribut especificat al mapatge \'Nombre ID\' al connector d\'autenticació de LDAP.';
