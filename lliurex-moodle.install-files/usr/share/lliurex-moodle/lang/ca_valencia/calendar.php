...
/**
 * Strings for component 'calendar', language 'ca_valencia', version '3.9'.
 *
 * @package     calendar
 * @category    string
...
$string['addevent'] = 'Afig esdeveniments';
...
$string['errorinvalidbydayprefix'] = 'Valors enters que precedisquen a regles BYDAY (PER_DIA) sols poden ser presents en una regla de recurrència MONTHLY (MENSUAL) o YEARLY (ANUAL).';
...
$string['errorinvalidinterval'] = 'El valor per l\'INTERVAL de la regla cal que siga un enter positiu.';
...
$string['explain_site_timeformat'] = 'Podeu triar la visualització de les hores a tot el lloc en format de 12 o 24 h. Si trieu «per defecte», el format es determinarà automàticament d\'acord amb l\'idioma del lloc. Els usuaris poden triar format, igualment, en les seues preferències.';
...
$string['pollinterval_help'] = 'Freqüència amb què vos agradaria que el calendari s\'actualitzés amb nous esdeveniments.';
$string['pref_lookahead'] = 'Esdeveniments propers';
$string['pref_lookahead_help'] = 'Això estableix el nombre (màxim) de dies futurs en què pot caure l\'inici d\'un esdeveniment per tal de mostrar-se com a esdeveniment proper. Els esdeveniments que comencen més enllà no es mostraran mai com a propers. Tingueu en compte que <strong>no hi ha cap garantia</strong> que els esdeveniments que comencen en aquest interval es mostren; si n\'hi ha molts (més que els especificats al paràmetre «Nombre màxim d\'esdeveniments propers») aleshores els més distants no es mostraran.';
...
$string['pref_startwday_help'] = 'Les setmanes del calendari es mostraran començant pel dia que escolliu ací.';
