...
$string['attlsintro'] = 'El propòsit d’este qüestionari es ajudar-nos a avaluar les vostres actituds envers el pensament i l’aprenentatge.
...
$string['cannotfindanswer'] = 'Encara no hi ha respostes per esta enquesta.';
$string['cannotfindquestion'] = 'La qüestió no existeix';
$string['cannotfindsurveytmpt'] = 'Falta la plantilla de l\'enquesta!';
$string['ciq5'] = 'Quin esdeveniment li ha sorprés més?';
$string['ciqintro'] = 'Contesta les següents preguntes pensant en els esdeveniments ocorreguts durant la setmana passada en esta classe.';
$string['clicktocontinue'] = 'Fes clic ací per a continuar';
$string['clicktocontinuecheck'] = 'Fes clic ací per a revisar i continuar';
$string['colles10'] = 'Demano a altres estudiants que m’expliquin les seues  idees.';
$string['colles11'] = 'altres estudiants em demanen que expliqui les meues idees.';
$string['colles12'] = 'altres estudiants responen a les meues idees.';
$string['colles16'] = 'el tutor exemplifica l\'auto reflexió crítica.';
$string['colles16short'] = 'El tutor exemplifica l\'auto reflexió';
$string['colles18'] = 'els altres estudiants elogien la meua contribució.';
$string['colles19'] = 'altres estudiants valoren la meua contribució.';
$string['colles2'] = 'el que aprenc és important per a la meua pràctica professional.';
$string['colles2short'] = 'Important per a la meua pràctica';
$string['colles3'] = 'aprenc com millorar la meua pràctica professional.';
$string['colles3short'] = 'Milloro la meua pràctica';
$string['colles4'] = 'el que aprenc te relació amb la meua pràctica professional';
$string['colles4short'] = 'Te relació amb la meua pràctica';
$string['colles6'] = 'Penso críticament sobre les meues pròpies idees.';
$string['colles6short'] = 'Sóc crític amb les meues pròpies idees';
$string['colles9'] = 'Explico les meues idees a altres estudiants.';
$string['colles9short'] = 'Explico les meues idees';
$string['collesaintro'] = 'El propòsit d’esta enquesta és ajudar-nos a entendre fins a quin punt la presentació en línia d’esta unitat et va facilitar l’aprenentatge.
Cada una de les 24 declaracions següents t’interroga sobre la teva experiència en esta unitat.
