...
/**
 * Strings for component 'auth_ldap', language 'ca_valencia', version '3.9'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_ad_create_req'] = 'No s\'ha pogut crear el nou compte en el Directori Actiu. Assegureu-vos que compliu tots els requeriments necessaris perquè això funcione (connexió LDAPS, bind-user amb els drets adequats, etc.)';
...
$string['auth_ldap_bind_dn'] = 'Si voleu utilitzar el bind-user per cercar usuaris, especifiqueu-ho ací. Per exemple \'cn=ldapuser,ou=public,o=org\\';
...
$string['auth_ldap_expiration_warning_desc'] = 'Nombre de dies abans que isca l\'avís de venciment de la contrasenya.';
...
$string['auth_ldap_gracelogins_desc'] = 'Fa que funcione el gracelogin de LDAP. Després que haja vençut la contrasenya, l\'usuari pot seguir entrant fins que el valor del gracelogin siga 0. Si habiliteu aquest paràmetre, es visualitzarà un missatge d\'avís quan vença la contrasenya.';
...
$string['auth_ldap_host_url'] = 'Especifiqueu el servidor LDAP en format URL, per exemple \'ldap://ldap.myorg.com/\' o \'ldaps://ldap.myorg.com/\'. Separeu els diferents servidors amb \';\' per tindre protecció contra fallades.';
...
$string['auth_ldap_noextension'] = '<em>El mòdul PHP LDAP no sembla que estiga present. Assegureu-vos que està instal·lat i habilitat, si voleu utilitzar aquest connector d\'autenticació. </em>';
$string['auth_ldap_objectclass'] = 'Opcional: Sobreescriu l\'objectClass usada per anomenar/cercar usuaris en ldap_user_type. Normalment no vos caldrà canviar-ho.';
...
$string['auth_ldap_preventpassindb'] = 'Seleccioneu «sí» per impedir que les contrasenyes s\'emmagatzemen a la base de dades de Moodle.';
$string['auth_ldap_preventpassindb_key'] = 'Oculta contrasenyes';
$string['auth_ldap_search_sub'] = 'Poseu el valor <> 0 si voleu buscar els usuaris en subcontextos.';
$string['auth_ldap_search_sub_key'] = 'Busca subcontextos';
$string['auth_ldap_server_settings'] = 'Paràmetres del servidor LDAP';
$string['auth_ldap_suspended_attribute'] = 'Opcional: Si està present, este atribut s\'utilitzarà per activar/suspendre el compte d\'usuari creat localment.';
...
$string['auth_ldap_user_attribute'] = 'Opcional: substitueix l\'atribut utilitzat per anomenar/buscar usuaris. Generalment \'cn\'.';
$string['auth_ldap_user_attribute_key'] = 'Atribut d\'usuari';
$string['auth_ldap_user_exists'] = 'Este nom d\'usuari LDAP ja existeix.';
$string['auth_ldap_user_settings'] = 'Paràmetres de consulta d\'usuaris';
$string['auth_ldap_user_type'] = 'Seleccioneu com s\'emmagatzemen els usuaris en LDAP. Este paràmetre també especifica com funcionarà el venciment de les contrasenyes, el nombre d\'inicis de sessió de gràcia i la creació d\'usuaris.';
...
Si un nom d\'usuari i una contrasenya són vàlids, Moodle crea una entrada per a un usuari nou a la seua base de dades. Aquest mòdul pot llegir atributs de l\'usuari del LDAP i omplir els camps corresponents de Moodle. En els inicis de sessió successius només es comproven el nom d\'usuari i la contrasenya.';
$string['auth_ldapextrafields'] = 'Aquests camps són opcionals. Podeu triar d\'omplir alguns camps d\'usuari de Moodle amb informació dels <b>camps LDAP</b> especificats ací. <p>Si els deixeu en blanc, aleshores s\'utilitzaran valors per defecte.<p>En tot cas, l\'usuari podrà editar tots aquests camps quan es connecte.';
...
$string['auth_ntlmsso_ie_fastpath'] = 'Habiliteu esta opció per activar el camí ràpid NTLM SSO ( obviareu certs passos i sols treballarà si el client és MS Internet Explorer).';
$string['auth_ntlmsso_ie_fastpath_key'] = 'Camí ràpid MS IE ?';
$string['auth_ntlmsso_maybeinvalidformat'] = 'No ha estat possible extraure el nom d\'usuari de la capçalera REMOTE_USER. És correcte el format configurat?';
$string['auth_ntlmsso_remoteuserformat'] = 'Si heu escollit «NTLM» en el «Tipus d\'autenticació», podeu especificar ací el format del nom d\'usuari remot. Si deixeu aquest camp buit, s\'utilitzarà el format per defecte DOMAINusername. Podeu utilitzar el text variable optatiu <b>%domain%</b> per especificar on apareix el nom de domini, i l\'obligatori <b>%username%</b> per especificar on apareix el nom d\'usuari.<br /><br />Alguns formats molt utilitzats són <tt>%domain%%username%</tt> (per defecte en MS Windows), <tt>%domain%/%username%</tt>, <tt>%domain%+%username%</tt> i simplement <tt>%username%</tt> (si no hi ha la part de domini).';
$string['auth_ntlmsso_subnet'] = 'Si la definiu, només s\'intentarà l\'autenticació única amb els clients que estiguen dins d\'aquesta subxarxa. Format: xxx.xxx.xxx.xxx/màscara. Múltiples subxarxes separades per  \',\' (coma).';
...
$string['didntgetusersfromldap'] = 'Encara no hi usuaris LDAP -- error ? -- S\'està eixint.';
...
$string['needbcmath'] = 'Vos cal l\'extensió BCMath per utilitzar els inicis de sessió de gràcia amb l\'Active Directory.';
$string['needmbstring'] = 'Vos cal l\'extensió mbstring per canviar contrasenyes al directori actiu.';
...
$string['pagesize'] = 'Assegureu-vos que este valor és menor que el límit de mida de conjunt de resultats del servidor LDAP (el nombre màxim d\'entrades que poden ser retornades en una consulta)';
...
$string['updateusernotfound'] = 'No s\'ha pogut trobar l\'usuari mentres s\'actualitzava externament. Detalls: busca a la base: \'{$a->userdn}\'; filtre de busca: \'(objectClass=*)\'; atributs de busca: {$a->attribs}';
