...
/**
 * Strings for component 'auth_ldap', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_ldap
...
$string['auth_ldap_creators'] = 'Llista de grups als membres dels quals els és permés  crear nous cursos. Separeu els grups amb \';\'. Generalment una cosa paregut a \'cn=teachers,ou=staff,o=myorg';
$string['auth_ldap_creators_key'] = 'Creadors';
$string['auth_ldapdescription'] = 'Este mètode proporciona autenticació contra un servidor LDAP extern.

Si un nom d\'usuari i una contrasenya són vàlids, Moodle crea una entrada per a un nou usuari a la seua base de dades. Este mòdul pot llegir atributs de l\'usuari del LDAP i omplir els camps corresponents de Moodle. En connexions successives només es comproven el nom d\'usuari i la contrasenya.';
...
$string['auth_ldapextrafields'] = 'Estos camps són opcionals. Podeu triar d\'omplir alguns camps d\'usuari de Moodle amb informació dels <b>camps LDAP</b> especificats ací. <p>Si els deixeu en blanc, aleshores s\'utilitzaran valors per defecte.<p>En tot cas, l\'usuari podrà editar tots estos camps quan es connecte.';
...
$string['auth_ldap_gracelogins_desc'] = 'Fa que funcione el gracelogin de LDAP. Després que haja vençut la contrasenya, l\'usuari pot seguir entrant fins que el compte del gracelogin és 0. Si habiliteu este paràmetre es visualitzarà un missatge d\'avís quan vença la contrasenya.';
...
$string['auth_ldap_noextension'] = '<em>El mòdul PHP LDAP no pareix que siga present. Per favor assegureu-vos que està instal·lat i habilitat si voleu utilitzar este connector d\'autenticació. </em>';
...
$string['auth_ldap_objectclass'] = 'Filtre utilitzat per nomenar/cercar usuaris. Generalment es defineix quelcom paregut a objectClass=posixAccount. Per defecte objectClass=*, que retorna tots els objectes de LDAP.';
...
$string['auth_ldap_preventpassindb'] = 'Seleccioneu \'sí\' per impedir que les contrasenyes s\'emmagatzemen en la base de dades de Moodle.';
...
$string['auth_ldap_user_type'] = 'Seleccioneu com s\'emmagatzemen els usuaris en LDAP. Este paràmetre també especifica com funcionarà el venciment de les contrasenyes, el període de gràcia i la creació d\'usuaris.';
...
$string['auth_ntlmsso_subnet'] = 'Si la definiu, només s\'intentarà l\'autenticació única amb els clients que estiguen dins d\'esta subxarxa. Format: xxx.xxx.xxx.xxx/màscara. Múltiples subxarxes separades per  \',\' (coma).';
...
$string['needbcmath'] = 'Vos cal l\'extensió BCMath per utilitzar l\'entrada amb el directori actiu.';
