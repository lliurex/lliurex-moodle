...
/**
 * Strings for component 'auth_fc', language 'ca_valencia', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_fc
...
$string['auth_fccreators'] = 'Llista de grups als membres dels quals els és permés de crear nous cursos. Separeu els diferents grups amb \';\'. Els noms han de ser exactament iguals als del servidor FirstClass. El sistema distingeix majúscules i minúscules.';
$string['auth_fccreators_key'] = 'Creadors';
$string['auth_fcdescription'] = 'Este mètode utilitza un servidor FirstClass per comprovar si el nom d\'usuari i la contrasenya són vàlids.';
...
$string['auth_fcpasswd'] = 'Contrasenya d\'este compte.';
