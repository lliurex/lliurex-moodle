...
/**
 * Strings for component 'quizaccess_seb', language 'es', version '3.9'.
 *
...
$string['clientrequiresseb'] = 'Este cuestionario ha sido diseñado para que se use Safe Exam Browser con la configuración del cliente.';
...
$string['disabledsettings_help'] = 'La configuración del cuestionario de Safe Exam Browser no puede cambiarse si el cuestionario ha sido realizado. Para cambiar la configuración primero se deben eliminar todos los intentos realizados.';
...
$string['fileparsefailed'] = 'El archivo subido no se pudo guardar como un fichero de configuración SEB.';
...
$string['seb_allowedbrowserexamkeys'] = 'Claves de navegador seguro permitidas';
$string['seb_allowreloadinexam'] = 'Permitir recargar el examen';
$string['seb_allowspellchecking'] = 'Habilitar la revisión ortográfica';
...
$string['seb_muteonstartup_help'] = 'Si está habilitado, el audio se silencia cuando se inicia SEB.';
...
$string['seb_showsebdownloadlink'] = 'Mostrar el botón de descarga de Safe Exam Browser';
$string['seb_showsebtaskbar'] = 'Mostrar la barra de tareas de SEB';
$string['seb_showtime'] = 'Mostrar la hora';
$string['seb_showwificontrol'] = 'Mostrar el control de Wi-Fi';
...
$string['setting:downloadlink_desc'] = 'URL para descargar la aplicación de Safe Exam Browser';
$string['settingsfrozen'] = 'Debido a que hubo al menos un intento de cuestionario, la configuración de Safe Exam Browser ya no se puede actualizar.';
