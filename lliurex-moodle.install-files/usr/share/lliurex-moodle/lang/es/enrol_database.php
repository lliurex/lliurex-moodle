...
/**
 * Strings for component 'enrol_database', language 'es', branch 'MOODLE_20_STABLE'
 *
...
$string['pluginname_desc'] = 'Puede utilizar una base de datos externa (de casi cualquier tipo) para controlar sus matriculaciones. Se da por supuesto que su base de datos externa contiene al menos un campo que contiene un identificador de curso, y un campo que contiene un identificador de usuario. Estos se comparan con los campos que usted elija en el curso local y las tablas de usuario.';
...
$string['remotecoursefield_desc'] = 'Nombre del campo en la tabla remota que se corresponde con las entradas en la tabla de cusos';
...
$string['remoterolefield_desc'] = 'Nombre del campo en la tabla remota que se corresponde con las entradas en la tabla de roles';
...
$string['remoteuserfield_desc'] = 'Nombre del campo en la tabla remota que se corresponde con las entradas en la tabla de usuarios';
...
$string['templatecourse_desc'] = 'Opcional: los cursos auto-creados pueden copiar sus ajustes a partir de una plantilla de curso. Indique aquí el nombe de esta plantilla de curso.';
