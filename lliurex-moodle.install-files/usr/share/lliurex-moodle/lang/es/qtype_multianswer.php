...
/**
 * Strings for component 'qtype_multianswer', language 'es', branch 'MOODLE_20_STABLE'
 *
...
$string['questionsless'] = '{a} preguntas menos que en la pregunta multirespuesta guardadas en la base d edatos';
$string['questionsmissing'] = 'No hay preguntas válidas, escriba al menos una pregunta';
$string['questionsmore'] = '{a} preguntas más que en la pregunta multirespuesta guardadas en la base d edatos';
