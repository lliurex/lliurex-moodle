...
/**
 * Strings for component 'repository', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   repository
...
$string['configallowexternallinks'] = 'Esta opción permite a los usuarios  decidir si los elementos externos se copian o no en Moodle. Si está desactivado entonces los elementos siempre se copiarán en Moodle (en general, es lo mejor para la integridad de los datos y la seguridad). Si está activado, el usuario podrá decidir  cada vez que añada un elemento externo a un texto';
...
$string['errorpostmaxsize'] = 'El fichero subido excede el límite de la directiva max_post_size en php.ini';
...
$string['fileexistsdialogheader'] = 'El archivo ya existe';
...
$string['filesizenull'] = 'No se puede determinar el tamaño del fichero';
...
$string['popup'] = 'Hagla clic sobre el botón "Login" para conectarse';
...
$string['repositoryerror'] = 'El repositorio remoto devolvió el error: {$a}';
$string['save'] = 'Guardar';
