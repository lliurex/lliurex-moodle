...
$string['backupadhocpending'] = 'Hay pendiente una tarea ad hoc de respaldo de curso';
...
La cookie esencial es la de sesión, normalmente llamada MoodleSession.
Debe permitir que su navegador la acepte para poder mantener el servicio
funcionando mientras navega el sitio. Cuando sale de la plataforma o cierra su navegador la \'cookie\' se destruye (en su navegador y en el servidor).

La otra \'cookie\', normalmente llamada MOODLEID o similar, es para su comodidad. Se limita a recordar su nombre de usuario dentro del navegador. Esto significa que cuando regresa al sitio, se escribirá automáticamente su nombre en el campo nombre de usuario
Si desea mayor seguridad no utilice esta opción: sólo tendrá que escribir su nombre manualmente cada vez que quiera iniciar sesión.';
...
$string['registrationyes'] = 'Sí, envíeme notificaciones sobre nuevas versiones liberadas de Moodle, alertas de seguridad y otras noticias importantes';
