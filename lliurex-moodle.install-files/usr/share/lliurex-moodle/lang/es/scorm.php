...
$string['whatgrade_help'] = 'Si se permiten varios intentos, esta opción especifica si el intento más alto, el promedio (media), el primer intento o el último se registran en el libro de calificaciones.';
