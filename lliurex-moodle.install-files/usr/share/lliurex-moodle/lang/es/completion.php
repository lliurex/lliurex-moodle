...
/**
 * Strings for component 'completion', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   completion
...
$string['completion-alt-manual-n'] = 'No completado; seleccione para marcar como completo';
$string['completion-alt-manual-y'] = 'Completado; seleccione para marcar como no completo';
...
Si se muestra una casilla en blanco, entonces será posible hacer clic sobre ella para activarla e indicar que la actividad se ha realizado. Si se vuelve a hacer clic sobre ella, la marca desaparece. Esto es una acción opcional que se utiliza para llevar un seguimiento personal del progreso a través del curso.

Si se muestra una casilla punteada, la marca aparecerá cuando se haya completado la actividad de acuerdo con las condiciones establecidas por el profesor.';
...
$string['completion-title-manual-y'] = 'Marcar como no completo';
...
$string['notenroled'] = 'Usted no está matriculado
en este curso';
$string['notyetstarted'] = 'Aún no comenzado';
$string['overallcriteriaaggregation'] = 'Criterios generales de agregación de tipo';
