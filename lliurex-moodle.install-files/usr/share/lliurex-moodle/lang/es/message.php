...
/**
 * Strings for component 'message', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   message
...
$string['couldnotfindpreference'] = 'No se puede cargar la preferencia {$a}. ¿El componente y el nombre que ha proporcionado a message_send() coinciden con una fila de message_providers? Los proveedores de mensajes debe aparecer en la base de datos para que los usuarios puedan configurar la forma en que serán notificados cuando reciban mensajes.';
