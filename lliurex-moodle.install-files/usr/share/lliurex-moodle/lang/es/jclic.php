...
/**
 * Strings for component 'jclic', language 'es', branch 'MOODLE_20_STABLE'
 *
 * @package   jclic
...
Este módulo le permite a los profesores añadir actividades JClic a cualquier curso y seguir el resultado de los pupilos (tiempo empleado en cada actividad, número de intentos, puntuación, etc).';
