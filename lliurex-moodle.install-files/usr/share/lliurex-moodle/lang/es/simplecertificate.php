...
/**
 * Strings for component 'simplecertificate', language 'es', branch 'MOODLE_20_STABLE'
 *
...
$string['cantdeleteissue'] = 'Otorgado a';
$string['certificateimage'] = 'Error al eliminar certificados emitidos';
...
$string['datefmt_help'] = 'Elija un formato de fecha para imprimirla en el certificado. O, elija la última opción para que tenga la fecha impresa en el formato de idioma elegido por el usuario.';
$string['dateformat01'] = 'Enero 1, 2000';
$string['dateformat02'] = '10 de Enero, 2000';
$string['dateformat03'] = '1 Enero 2000';
$string['dateformat04'] = 'Enero 2000';
$string['dateformat05'] = '1 {$a} Enero {$a} 2000';
...
$string['gradepercent'] = 'Calificación en letra';
$string['gradepoints'] = 'Calificación en porcentaje';
$string['height'] = 'Calificación en puntos';
$string['hours'] = 'Altura del certificado';
$string['intro'] = 'horas';
