...
/**
 * Strings for component 'qtype_numerical', language 'es', branch 'MOODLE_20_STABLE'
 *
...
$string['numericalinstructions'] = 'Instrucciones';
$string['numericalinstructions_help'] = 'Especifique las instrucciones relacionadas con la pregunta como
<br> * Ejemplos de formatos de número
<br> * Unidades complejas';
...
$string['unitdisplay'] = '<STRONG>Se utiliza la \'Unidad 1\' </ STRONG>';
$string['unitedit'] = 'Editar unidad';
$string['unitgraded'] = 'La RESPUESTA-NUMÉRICA y las UNIDADES se calificarán';
$string['unitgraded1'] = '<STRONG>UNIDAD CALIFICADA</ STRONG>';
...
$string['unitnotgraded'] = '<STRONG>UNIDAD NO CALIFICADA</ STRONG>';
$string['unitnotselected'] = 'No se ha seleccionado unidad';
$string['unitnotused'] = '<STRONG>No se usa unidad</ STRONG>';
$string['unitnotvalid'] = 'Las unidades no son válidas con es te valor númerico';
...
$string['unitshandling'] = 'Tratamiento de unidades';
$string['unitsused'] = '<STRONG>Unidad opcional</STRONG>';
$string['unitunknown'] = 'Unidad no definida';
$string['unitused'] = '<STRONG>UNIDAD USADA</STRONG>';
$string['unituses_help'] = 'Las unidades se utiliza a partir de la versión de Moodle 2.0.
<br>* El estudiante puede responder con unidades predefinidas por el profesor
<br>* en cuyo caso la constante se aplicará al valor de los estudiantes
<br> * si el estudiante no añade ninguna unidad, se utiliza sólo su respuesta-numérica.';
...
* si usa la coma (,) como separador de miles *siempre* ponga el punto decimal (.), como en 13,500.67 : 13,500.
* para el formato exponencial como 1.350067 * 10<sup>4</sup>, utilice 1.350067 E4 : 1.350067 E04';
