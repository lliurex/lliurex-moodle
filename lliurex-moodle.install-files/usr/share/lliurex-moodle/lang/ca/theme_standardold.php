...
$string['choosereadme'] = 'Aquest tema ha sigut dissenyat per treballar amb IE6 i altres navegadors antics.

Les notes de la versió Moodle 2.0 especifiquen que IE6 no serà suportat més temps, no obstant no em pogut comprovar que funcioni correctament amb alguns problemes visuals lleus.

Aquest tema està aquí per la gent que està atrapada amb IE6 com un tema útil encara que en algunes àrees específiques de Moodle 2.0 puguin haver problemes per funcionar de forma correcta.
