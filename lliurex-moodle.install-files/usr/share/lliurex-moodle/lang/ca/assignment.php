...
/**
 * Strings for component 'assignment', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   assignment
...
$string['enableemailnotification_help'] = '<p>Si activeu aquesta opció, l\'estudiantat rebrà notificacions per correu referents a les seves qualificacions i retroacció.</p>
...
$string['helpupload'] = '<p>Aquest tipus de tasca permet que cada participant pengi un fitxer, o diversos fitxers, de qualsevol mena. Poden ser documents del processador de textos, imatges, un lloc web complet empaquetat en un fitxer zip, o qualsevol altra cosa que els vulgueu demanar que trametin.</p>
<p>Aquest tipus també us permet penjar múltiples fitxers en resposta a les trameses dels participants. Aquests fitxers es poden penjar fins i tot abans de les trameses, cosa que es pot emprar per lliurar a cada participant fitxers diferents per treballar.</p>
...
<p>La tramesa d\'aquest tipus de tasca ha de ser finalitzada manualment pel participant. Vós podeu revisar el seu estat en qualsevol moment; les tasques inacabades es marquen com a esborrany. Podeu retornar qualsevol tasca no qualificada a l\'estat d\'esborrany.</p>';
