...
/**
 * Strings for component 'repository', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   repository
...
$string['confirmdelete'] = 'Esteu segur que voleu suprimir el repositori - {$a}?';
$string['confirmdeletefile'] = 'Esteu segur que voleu suprimir el fitxer?';
$string['confirmremove'] = 'Esteu segur que voleu suprimir aquest connector de repositori, les seves opcions i <strong>totes les seves instàncies</strong> - {$a}?';
