...
/**
 * Strings for component 'calendar', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   calendar
...
$string['pref_maxevents_help'] = 'Aquest paràmetre és el nombre màxim d\'esdeveniments que poden visualitzar-se. Si poseu un nombre massa gran es possible que esdeveniments pròxims ocupin molt espai en la vostra pantalla.';
...
$string['pref_startwday_help'] = 'La setmana del calendari començarà el dia que marqueu aquí.';
...
$string['repeatedevents'] = 'Esdeveniments repetits';
...
$string['repeatevent'] = 'Repeteix aquest edeveniment';
