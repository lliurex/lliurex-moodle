...
/**
 * Strings for component 'webservice', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   webservice
...
$string['accessnotallowed'] = 'Accés al servei web no permès';
...
$string['errorinvalidparamsapi'] = 'Paràmetre invàlid de l\'API externa.';
$string['errorinvalidparamsdesc'] = 'Descripció invàlida de l\'API externa.';
$string['errorinvalidresponseapi'] = 'Resposta invàlida de l\'API externa.';
$string['errorinvalidresponsedesc'] = 'Descripció de la resposta invàlida de l\'API externa.';
$string['errormissingkey'] = 'Clau requerida perduda en l\'estructura única: {$a}';
...
$string['errorresponsemissingkey'] = 'Error en la resposta - Manca la següent clau requerida en una sola estructura: {$a}';
$string['errorscalartype'] = 'S\'esperava un tipus escalar, s\'ha rebut una matriu o un objecte.';
$string['errorunexpectedkey'] = 'Claus inesperades ({$a}) detectades en matriu de paràmetres.';
...
$string['invalidtokensession'] = 'Sessió invàlida degut al token - sessió no trobada o expirada';
...
$string['wsauthmissing'] = 'El connector d\'autenticació de serveis web s\'ha perdut.';
$string['wsauthnotenabled'] = 'El connector d\'autenticació de serveis web està desactivat.';
