...
/**
 * Strings for component 'moodle', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   moodle
...
$string['category_help'] = '<p>L\'administrador de Moodle pot haver configurat diferents categories de cursos.</p>
...
$string['flashlinkmessage'] = 'Actualitzeu el vostre connector de Flash:';
$string['flashupgrademessage'] = 'Aquest contingut requereix el connector de Flash, però la versió que teniu és massa antiga.

Potser us caldrà sortir de la sessió i tornar a entrar-hi després de fer l\'actualització.';
...
$string['format_help'] = '<p><b>Format setmanal</b></p>
...
$string['hidetopicfromothers'] = 'Oculta el tema';
$string['hideweekfromothers'] = 'Oculta la setmana';
...
$string['legacythemesaved'] = 'Tema nou desat';
...
$string['loginsteps'] = 'L\'accés complet als cursos requereix que dediqueu un minut a la creació d\'un compte nou d\'usuari vàlid en aquest lloc web. Cada curs pot requerir també una «clau d\'inscripció» d\'un sol ús que no necessitareu fins més tard. Els passos que heu de seguir són els següents:
<ol>
<li>Ompliu el formulari de <a href="{$a}">Compte nou</a> amb les vostres dades.</li>
...
$string['notifyloginfailuresmessageend'] = 'Podeu veure aquí aquests registres: {$a}/course/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors.';
...
$string['showtopicfromothers'] = 'Mostra tema';
$string['showweekfromothers'] = 'Mostra setmana';
$string['since'] = 'Des de';
...
$string['useforlegacytheme'] = 'Utilitza\'l en navegadors antics';
$string['useformaintheme'] = 'Utilitza\'l en navegadors recents';
