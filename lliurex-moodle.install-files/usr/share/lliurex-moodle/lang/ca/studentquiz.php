...
/**
 * Strings for component 'studentquiz', language 'ca', version '3.9'.
 *
 * @package     studentquiz
 * @category    string
...
$string['messageprovider:approved'] = 'Notificació de pregunta aprovada';
$string['messageprovider:changed'] = 'Notificació de pregunta modificada';
...
$string['messageprovider:deleted'] = 'Notificació de pregunta eliminada';
...
$string['studentquiz:emailnotifydeleted'] = 'Notificació de pregunta eliminada';
