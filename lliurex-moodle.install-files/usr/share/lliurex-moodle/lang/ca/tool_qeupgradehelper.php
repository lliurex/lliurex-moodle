...
/**
 * Strings for component 'tool_qeupgradehelper', language 'ca', version '3.9'.
 *
...
$string['invalidquizid'] = 'Identificador (ID) no vàlid de qüestionari. O bé el qüestionari no existeix o no té respostes per convertir.';
