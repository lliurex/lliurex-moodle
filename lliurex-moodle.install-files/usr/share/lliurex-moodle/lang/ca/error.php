...
/**
 * Strings for component 'error', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   error
...
$string['cannotnetgeo'] = 'No s\'ha pogut connectar al servidor NetGeo a http://netgeo.caida.org, comproveu la configuració del proxy o, encara millor, instal·leu el fitxer de dades de MaxMind GeoLite City.';
...
$string['invalidgradeitmeid'] = 'L\'ID de l\'element de qualificació no és correcte';
