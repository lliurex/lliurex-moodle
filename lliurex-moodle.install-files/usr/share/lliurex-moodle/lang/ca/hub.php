...
/**
 * Strings for component 'hub', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   hub
...
$string['publishonmoodleorg'] = 'Fes públic en MOOCH';
...
$string['registeredon'] = 'Registrat amb ';
$string['registeredsites'] = 'Llocs registrats';
$string['registeron'] = 'Registre del lloc web';
$string['registeronmoodleorg'] = 'Registrat amb Moodle.org (MOOCH)';
$string['registeronspecifichub'] = 'Registra en un hub específic';
...
$string['shareonmoodleorg'] = 'Puja aquest curs al MOOCH';
...
$string['specifichub'] = 'Hub específic';
