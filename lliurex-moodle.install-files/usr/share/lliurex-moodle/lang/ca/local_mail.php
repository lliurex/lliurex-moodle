...
/**
 * Strings for component 'local_mail', language 'ca', version '3.9'.
 *
 * @package     local_mail
 * @category    string
...
$string['cannotcompose'] = 'No podeu redactar missatges perquè no us heu inscrit a cap curs.';
$string['cc'] = 'A/c';
...
$string['emptytrash'] = 'Paperera buida';
$string['emptytrashconfirm'] = 'Ara buidareu la paperera';
...
$string['messagedeleteconfirm'] = 'Ara suprimireu definitivament el missatge \'{$a}\\';
