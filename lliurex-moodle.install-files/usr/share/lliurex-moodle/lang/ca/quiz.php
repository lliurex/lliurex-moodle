...
/**
 * Strings for component 'quiz', language 'ca', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz
...
$string['decimalplaces_help'] = '<p>Utilitzant aquest paràmetre podeu seleccionar el nombre de decimals que es mostraran en la qualificació de cada intent.</p';
...
$string['emailnotifysmall'] = '{$a->studentname} ha completat {$a->quizname}';
...
$string['matchgradesnearest'] = 'Valor més proper si no és a la llista';
$string['max'] = 'Màx.';
...
$string['reviewoptionsheading_help'] = 'Aquestes opcions controlen quina informació poden veure els usuaris quan revisen un intent del qüestionari o quan veuen els informes del qüestionari.
...
"Més tard, mentre encara estigui obert el qüestionari" vol dir després de passar els primers dos minuts i abans de la data de tancament del qüestionari.

"Després que es tanqui el qüestionari" vol dir després que hagi passat la data de tancament del qüestionari. Si el qüestionari no té data de tancament, no s\'arribarà mai a aquest punt.

Els usuaris que tinguin la capacitat \'Veure qualificacions ocultes pròpies\' [moodle/grade:viewhidden]
(generalment el professorat i administradors) no seran afectats per aquests paràmetres i sempre podran revisar tota la informació d\'intents en qualsevol moment.';
...
$string['timelimit_help'] = 'Si està activat, es mostra un temporitzador (necessita JavaScript) amb un compte enrere. Quan s\'ha assolit el límit de temps, es resol el qüestionari automàticament, siguin quines siguin les respostes que s\'hagin acabat d\'emplenar.';
...
$string['top'] = 'Dalt';
$string['totalpointsx'] = 'Nombre de puntuacions: {$a}';
...
$string['youcannotwait'] = 'El qüestionari es tanca abans que estigueu autoritzat a començar un altre intent';
